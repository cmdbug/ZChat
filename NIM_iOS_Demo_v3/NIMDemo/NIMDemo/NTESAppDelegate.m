...
//    [UINavigationBar appearance].barTintColor = [UIColor colorWithRed:58/255.0 green:158/255.0 blue:251/255.0 alpha:1.0];//wzteng设置导航栏颜色
...
- (void)setupMainViewController
{
    ...
    {
        [self setupLoginViewController];//登录界面
    }
}
