...
- (AVMutableVideoComposition *)fixedCompositionWithAsset:(AVAsset *)videoAsset {
    ...
    if (degrees != 0) {
        CGAffineTransform translateToCenter = CGAffineTransformMakeTranslation(0, 0);//wztng初始化
        CGAffineTransform mixedTransform = CGAffineTransformRotate(translateToCenter,M_PI);//wztng初始化
